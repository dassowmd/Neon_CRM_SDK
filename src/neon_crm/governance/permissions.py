...
class UserPermissions:
    ...
    def has_any_permission(
        self, resource: ResourceType, permissions: List[Permission]
    ) -> bool:
...
ROLE_PERMISSIONS: Dict[Role, Dict[ResourceType, Set[Permission]]] = {
    Role.VIEWER: {
        ...
        ResourceType.ADDRESSES: {Permission.READ},
        ...
        ResourceType.RECURRING_DONATIONS: {Permission.READ},
        ResourceType.SOFT_CREDITS: {Permission.READ},
    ...
    Role.EDITOR: {
        ...
        ResourceType.ADDRESSES: {Permission.READ, Permission.WRITE, Permission.UPDATE},
        ...
        ResourceType.ORDERS: {
            Permission.READ,
            Permission.UPDATE,
        },  # Can't create orders directly
        ResourceType.PAYMENTS: {
            Permission.READ,
            Permission.UPDATE,
        },  # Can't create payments directly
        ResourceType.PLEDGES: {Permission.READ, Permission.WRITE, Permission.UPDATE},
        ResourceType.RECURRING_DONATIONS: {
            Permission.READ,
            Permission.WRITE,
            Permission.UPDATE,
        },
        ResourceType.SOFT_CREDITS: {
            Permission.READ,
            Permission.WRITE,
            Permission.UPDATE,
        },
    ...
    Role.EVENT_MANAGER: {
        ...
        ResourceType.HOUSEHOLDS: {Permission.READ},
        ResourceType.MEMBERSHIPS: {Permission.READ},
        # Read access to fundraising and system resources
        ResourceType.CAMPAIGNS: {Permission.READ},
        ResourceType.GRANTS: {Permission.READ},
        ResourceType.PLEDGES: {Permission.READ},
        ResourceType.RECURRING_DONATIONS: {Permission.READ},
...
def create_user_permissions(
    user_id: str,
    role: Role,
    custom_overrides: Dict[ResourceType, Set[Permission]] = None,
) -> UserPermissions:
    ...
    return UserPermissions(
        user_id=user_id, role=role.value, resource_permissions=base_permissions
    )
